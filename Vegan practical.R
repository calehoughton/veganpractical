...
dat.all <- read.csv("~/veganpractical/doi_10/Species_list_full_2905.csv",sep=";")
...
plot(SAC.comb$richness,pch=1,lty=1,lwd=2,type="b",col="blue",ylim=c(0,max(rowMeans(Estim.comb$chao))),ylab="Richness",main="Fiji")
